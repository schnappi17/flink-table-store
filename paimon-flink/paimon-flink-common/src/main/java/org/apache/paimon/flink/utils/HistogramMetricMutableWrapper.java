...
/**
 * {@link Histogram} for getting the current value of a Paimon {@link org.apache.paimon.metrics.Histogram} metric.
 * */
public class HistogramMetricMutableWrapper implements Histogram {
    ...
    public void update(long l) {
        throw new UnsupportedOperationException("update operation is not supported in the mutable flink metrics wrapper.");
    }
